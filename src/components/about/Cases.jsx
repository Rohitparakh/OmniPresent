    ...
    ( 03 )
            ...
            <div className='flex flex-col items-center justify-center h-full w-full  mt-8'>
                <div className=' w-full h-96  flex lg:flex-row flex-col lg:gap-0 gap-4 items-center justify-betwen px-2'>
                    ...
                    <img src="/src/assets/about/p2p.svg" alt="" className=' h-64 w-96'/>
                    <div className='border-t border-black w-full flex lg:gap-2 gap-4 items-center justify-between lg:p-1'>
                    ...
                    <div className=' lg:w-[65%] h-full flex flex-col items-center justify-center relative'>
                      ...
                      <div className='absolute lg:block hidden bottom-1/2 right-0 w-full h-1 border-t-2 border-black'>
                ...
                <div className='  w-full h-96  flex lg:flex-row-reverse flex-col lg:gap-0 gap-4 items-center justify-betwen px-2 mt-16'>
                    ...
                    <img src="/src/assets/about/seatlab.svg" alt="" className=' h-64 w-96'/>
                    <div className='border-t border-black w-full flex lg:gap-2 gap-4 items-center justify-between lg:p-1'>
                        <div className="flex flex-col gap-0">
            ...
            <div className='h-40 w-full flex lg:flex-row flex-col items-center justify-center gap-10 lg:mt-0 mt-20'>
              ...
              <div className='border-b-2 border-black px-2 flex items-end cursor-pointer hover:scale-105 transition-all duration-500'>
                      <img src="/src/assets/about/share.svg" alt="" className='h-8'/> <p className=' font-nohemi text-lg pb-1 '>see more</p>
              </div>
