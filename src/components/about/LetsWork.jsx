  ...
  return (
    <div className="bg-black text-white relative">
      ...
      <div className="max-w-[calc(100vw_-_40px)] lg:max-w-[calc(100vw_-_140px)] mx-auto pt-16 flex px-4 flex-col items-center justify-start min-h-screen">
        ...
        <SectionHeader heading="our blueprint" index="02"/>
        ...
        <img src={bracketOpen} className="h-full hidden lg:block min-[1700px]:mt-[-10%]"/>
        <div ref={containerRef} className="flex items-center flex-col justify-start pt-20 max-w-3xl gap-4 w-full h-full">
          <div className="flex lg:flex-row flex-col gap-3 lg:gap-5">
            ...
            {/* Card 2 */}
            <motion.div
              className="flex flex-col-reverse justify-center items-start gap-1 lg:w-40 min-[1700px]:w-48 w-60 h-min lg:mt-[11rem] min-[1700px]:mt-[13rem] mt-10"
              initial={{ opacity: 0, y: 50 }}
              animate={isContainerInView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="flex lg:flex-row-reverse flex-col-reverse gap-10 relative w-full lg:mt-0 mt-10 justify-end lg:ml-[-200px]">
            ...
            {/* Card 4 */}
            <motion.div
              className="flex lg:flex-row flex-col lg:gap-0 gap-2 justify-center lg:items-end items-start lg:w-96 xl:gap-2 2xl:w-[34rem]"
              initial={{ opacity: 0, y: 50 }}
              animate={isContainerInView ? { opacity: 1, y: 0 } : {}}
