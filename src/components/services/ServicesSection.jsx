...
const ServicesSection = () => {
  ...
  return (
    <div className="bg-black text-white relative min-h-screen pb-16">
      ...
      {/* Services */}
      <div className='w-full min-h-64 mt-24 max-w-7xl mx-auto lg:px-8 px-6'>
        <motion.p 
          ref={ref1}
          variants={slideUp}
          initial="hidden"
          animate={isInView1 ? "visible" : "hidden"}
          className='text-6xl font-nohemi-ext font-bold lg:w-[75%] leading-[4.2rem] lg:ml-0 ml-auto lg:text-start text-end'
        >
          ...
          >
            ...
            >
              ...
              <div className='lg:hidden flex flex-col text-sm font-nohemi'>
                  ...
                  <p className='text-gray-400 text-xl font-[400]'>Omnipresent Founder/CEO</p>
                </div>
              <motion.img 
                src={face} 
                alt="face" 
